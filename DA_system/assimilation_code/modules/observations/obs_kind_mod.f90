...
integer, parameter, public ::                  QTY_1D_INTEGRAL =     1
integer, parameter, public ::              QTY_STATE_VAR_POWER =     2
integer, parameter, public ::            QTY_LARGE_SCALE_STATE =     3
integer, parameter, public ::            QTY_SMALL_SCALE_STATE =     4
integer, parameter, public ::                 QTY_1D_PARAMETER =     5
integer, parameter, public ::         QTY_TRACER_CONCENTRATION =     6
integer, parameter, public ::                QTY_TRACER_SOURCE =     7
                                                                              
                                                                              
integer, parameter, public :: MAX_DEFINED_QUANTITIES =     7
...
integer, parameter, public ::               RAW_STATE_VARIABLE =     1
integer, parameter, public ::         RAW_TRACER_CONCENTRATION =     2
integer, parameter, public ::                RAW_TRACER_SOURCE =     3
integer, parameter, public ::            RAW_STATE_1D_INTEGRAL =     4
integer, parameter, public ::              RAW_STATE_VAR_POWER =     5
integer, parameter, public ::                LARGE_SCALE_STATE =     6
integer, parameter, public ::                SMALL_SCALE_STATE =     7
                                                                              
                                                                              
integer, parameter, public :: MAX_DEFINED_TYPES_OF_OBS =     7
...
! Also associate types of obs with the quantity.
 ...
 obs_qty_info(           1 )%name = "QTY_1D_INTEGRAL"
 obs_qty_info(           1 )%nitems =            1
 obs_qty_info(           1 )%itemname(           1 ) = "desc"
 obs_qty_info(           1 )%itemvalue(           1 ) = "compute value with an integral"
                                                                              
 obs_qty_info(           2 )%index =            2
 obs_qty_info(           2 )%name = "QTY_STATE_VAR_POWER"
 obs_qty_info(           2 )%nitems =            1
 obs_qty_info(           2 )%itemname(           1 ) = "desc"
 obs_qty_info(           2 )%itemvalue(           1 ) = "raising a state value to a power"
                                                                              
 obs_qty_info(           3 )%index =            3
 obs_qty_info(           3 )%name = "QTY_LARGE_SCALE_STATE"
 obs_qty_info(           3 )%nitems =            1
 obs_qty_info(           3 )%itemname(           1 ) = "desc"
 obs_qty_info(           3 )%itemvalue(           1 ) = "state varies with large time/space scale"
                                                                              
 obs_qty_info(           4 )%index =            4
 obs_qty_info(           4 )%name = "QTY_SMALL_SCALE_STATE"
 obs_qty_info(           4 )%nitems =            1
 obs_qty_info(           4 )%itemname(           1 ) = "desc"
 obs_qty_info(           4 )%itemvalue(           1 ) = "state varies with small time/space scale"
                                                                              
 obs_qty_info(           5 )%index =            5
 obs_qty_info(           5 )%name = "QTY_1D_PARAMETER"
 obs_qty_info(           5 )%nitems =            0
                                                                              
 obs_qty_info(           6 )%index =            6
 obs_qty_info(           6 )%name = "QTY_TRACER_CONCENTRATION"
 obs_qty_info(           6 )%nitems =            0
                                                                              
 obs_qty_info(           7 )%index =            7
 obs_qty_info(           7 )%name = "QTY_TRACER_SOURCE"
...
obs_type_info(    2) = obs_type_type(RAW_TRACER_CONCENTRATION, &
    'RAW_TRACER_CONCENTRATION', QTY_TRACER_CONCENTRATION, .false., .false., .false.)
obs_type_info(    3) = obs_type_type(RAW_TRACER_SOURCE, &
    'RAW_TRACER_SOURCE', QTY_TRACER_SOURCE, .false., .false., .false.)
obs_type_info(    4) = obs_type_type(RAW_STATE_1D_INTEGRAL, &
    'RAW_STATE_1D_INTEGRAL', QTY_1D_INTEGRAL, .false., .false., .false.)
obs_type_info(    5) = obs_type_type(RAW_STATE_VAR_POWER, &
    'RAW_STATE_VAR_POWER', QTY_STATE_VAR_POWER, .false., .false., .false.)
obs_type_info(    6) = obs_type_type(LARGE_SCALE_STATE, &
    'LARGE_SCALE_STATE', QTY_LARGE_SCALE_STATE, .false., .false., .false.)
obs_type_info(    7) = obs_type_type(SMALL_SCALE_STATE, &
    'SMALL_SCALE_STATE', QTY_SMALL_SCALE_STATE, .false., .false., .false.)
