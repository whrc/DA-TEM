...
use netcdf
 ...
 character(len=*), parameter :: source = 'tem_to_dart_par.f90'
...
!==================================================================
 ...
 call initialize_utilities(progname='tem_to_dart_par')
...
deallocate(nfall0, nfall1, nfall2, krb0, krb1, krb2)
 ...
 call finalize_utilities('tem_to_dart_par')
